...
<body>
    ...
    <footer>
        <p1>&#169KIRUTHIKA M [212223040098]~SEC</p1>
    </footer>
</body>
</html>
...
<body>
    ...
    <div class="content">
        ...
        <div class="product">
            <img src="prod1.jpg" alt="Python Programming" width="200" height="200">
            <h3>1. Accounting Software</h3>
            <p>Price: $9999</p>
        </div>
        
        <div class="product">
            <img src="prod2.jpg" alt="Python Programming" width="200" height="200">
            <h3>2. Tax Software</h3>
            <p>Price: $4999</p>
        </div>
        
        <div class="product">
            <img src="prod3.jpg" alt="Python Programming" width="200" height="200">
            <h3>3. Bookkeeping Software</h3>
            <p>Price: $5999</p>
        </div>
        
        <div class="product">
            <img src="prod4.jpg" alt="Python Programming" width="200" height="200">
            <h3>4. Time Tracking Software</h3>
            <p>Price: $3499</p>
        </div>
        
        <div class="product">
            <img src="prod5.jpg" alt="Python Programming" width="200" height="200">
...
<body>
    ...
    <div class="content">
        ...
        <div class="product">
            <img src="p1.jpg" alt="Python Programming" width="200" height="200">
            <h3>person 1</h3>
        </div>
        
        <div class="product">
            <img src="p2.jpg" alt="Python Programming" width="200" height="200">
            <h3>person 2</h3>
        </div>
        
        <div class="product">
            <img src="p3.jpg" alt="Python Programming" width="200" height="200">
            <h3>person 3</h3>
        </div>
        
        <div class="product">
            <img src="p4.jpg" alt="Python Programming" width="200" height="200">
            <h3>person 4</h3>
        </div>
        
        <div class="product">
            <img src="p5.jpg" alt="Python Programming" width="200" height="200">
            <h3>person 5</h3>
        </div>
        
        <div class="product">
            <img src="p6.jpg" alt="Python Programming" width="200" height="200">
            <h3>person 6</h3>
        </div>
    ...
    <div class="content">
        ...
        <div class="contact-info">
            ...
            <div class="contact-item">
                ...
                <p>LinkedIn:</p>
                <ul>
                    <li><a href="https://www.linkedin.com/in/arjunns3705/" target="_blank">KIRUTHIKA M</a></li>
                </ul>
            </div>
            <div class="contact-item">
                ...
                <p>Instagram:</p>
                <ul>
                    <li><a href="https://www.instagram.com/arjunn07._/" target="_blank">kiruthuhere_.</a></li>
                </ul>
            </div>
            <div class="contact-item">
                <img src="gmail.png" alt="Gmail Logo">
                <p>Gmail: <a href="mailto:nsarjun3705@gmail.com">kiruthikamanivel975@gmail.com</a></p>
            </div>
        </div>
    </div>
    <footer>
...
![alt text](<Screenshot 2024-05-16 182913.png>)
![alt text](<Screenshot 2024-05-16 182709.png>)
![alt text](<Screenshot 2024-05-16 182208.png>)
![alt text](<Screenshot 2024-05-16 181818.png>)
